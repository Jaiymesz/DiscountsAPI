...
{    
    public function applyDiscount(object $discount, array $order, array $products, object $customer){
        ...
        foreach($order['items'] as $item){
            ...
            if($discount->multiples==true)$totalFreeItems = (floor($item['quantity']/$discount->criteriaQty)*$discount->totalFree);
            ...
            $order['discounts-applied'][] = $discount->name." (Added $totalFreeItems Free of ".$activeProduct->description.")";
